  ...
  return (
    <header className="sticky top-4 z-30 w-full">
      <div className="mx-auto w-full max-w-[1400px] px-4">
        <div
          className={cn(
            "flex items-center justify-between border px-5 backdrop-blur transition-[transform,border-radius,box-shadow,background-color,height,padding] duration-300 ease-out will-change-transform",
            isScrolled
              ? "-translate-y-4 h-14 rounded-b-2xl border-x border-b border-t-transparent bg-background/95 shadow-none"
              : "h-16 rounded-2xl bg-white/80 shadow-sm"
          )}
        >
